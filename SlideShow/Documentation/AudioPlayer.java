...
{
	/** Parent JFrame */
//	private AudioDemoMain m_ParentFrame;		// Not sure who this should be.
	...
	/** The AudioClip object defining the audio to play */
	...
	{
		m_AudioClip = ac;
//		m_ParentFrame = (AudioDemoMain)parent;			// Not sure who this should be
...
//        sequencer.addMetaEventListener(this);
 ...
 //   	m_AudioFile = m_ParentFrame.getAudioFile();			// Use setAudioFile
    	if(!loadAudioFile())
    ...
    private boolean loadAudioFile()
    {
    	...
    	// Is this clip active and so what if it is???
    	if(m_AudioClip.isClipActive())
    		System.out.println("Audio clip is active. What does this mean?");
    	else
    		System.out.println("Audio clip is not active. What does this mean?");
    		
    	m_AudioFile = new File(m_AudioClip.getFullPathName() +"/"+  m_AudioClip.getAudioFileName());
